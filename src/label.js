...
class Label {
    ...
    //looks like this could really benefit from strategy classes
    update(labelObject) {
    ...
    redraw() {
        /*
        //make a call to update - i dont want to change anything
        //I also dont want to call this.destroy()

        //delete the old pixi object
        this.text.destroy();
