  ...
  constructor(customConfig = null) {
    this.config = {
      ...
      boardLabel: {
        ...
        timelineFontFamily: 'Times New Roman',
        timelineFontSize: 96,
        timelineFontStyle: 'italic',
        timelineFontWeight: 'bold',
        timelineTextBaseline: 'alphabetic',
        showTurn: true,
        turnAlign: 'center',
        turnFontFamily: 'Times New Roman',
        turnFontSize: 96,
        turnFontStyle: 'italic',
        turnFontWeight: 'bold',
        turnTextBaseline: 'alphabetic',
        showFile: true,
        fileAlign: 'center',
        fileFontFamily: 'Times New Roman',
        fileFontSize: 36,
        fileFontStyle: 'normal',
        fileFontWeight: 'bold',
        fileTextBaseline: 'bottom',
        showRank: true,
        rankAlign: 'center',
        rankFontFamily: 'Times New Roman',
        rankFontSize: 36,
        rankFontStyle: 'normal',
        rankFontWeight: 'bold',
        rankTextBaseline: 'bottom',
        fadeDuration: 250,
      },
      boardShadow: {
        show: true,
